    ...
    describe ".new" do
      it "=> create instance without database name", tags: "migration" do
        m = Crymon::Migration::Monitor.new(
          ...
          "model_list": [Helper::FilledModel.new, Helper::AuxiliaryModel.new]
        )
        #
        ...
        #
        m.model_list.should eq([Helper::FilledModel.new, Helper::AuxiliaryModel.new])
      end
