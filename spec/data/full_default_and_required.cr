...
module Spec::Data
  ...
  struct FullDefaultAndRequired < DynFork::Model
    ...
    getter choice_text = DynFork::Fields::ChoiceTextField.new(required: true)
    getter choice_text_mult = DynFork::Fields::ChoiceTextMultField.new(required: true)
    getter choice_text_dyn = DynFork::Fields::ChoiceTextDynField.new(required: true)
    getter choice_text_mult_dyn = DynFork::Fields::ChoiceTextMultDynField.new(required: true)

    getter choice_i64 = DynFork::Fields::ChoiceI64Field.new(required: true)
    getter choice_i64_mult = DynFork::Fields::ChoiceI64MultField.new(required: true)
    getter choice_i64_dyn = DynFork::Fields::ChoiceI64DynField.new(required: true)
    getter choice_i64_mult_dyn = DynFork::Fields::ChoiceI64MultDynField.new(required: true)

    getter choice_f64 = DynFork::Fields::ChoiceF64Field.new(required: true)
    getter choice_f64_mult = DynFork::Fields::ChoiceF64MultField.new(required: true)
    getter choice_f64_dyn = DynFork::Fields::ChoiceF64DynField.new(required: true)
    getter choice_f64_mult_dyn = DynFork::Fields::ChoiceF64MultDynField.new(required: true)
