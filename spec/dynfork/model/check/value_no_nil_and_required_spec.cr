require "../../../spec_helper"
require "../../../data/value_no_nil_and_required"

describe DynFork::Model do
  describe "#check" do
    it "=> validation of instance of `ValueNoNilAndRequired` model", tags: "check_required" do
      # Init data for test.
      #
      ...
      # HELLISH BURN
      # ------------------------------------------------------------------------
      m = Spec::Data::ValueNoNilAndRequired.new
      #
      # Init `value`
      ...
      collection : Mongo::Collection = DynFork::Globals.cache_mongo_database[
        Spec::Data::ValueNoNilAndRequired.meta[:collection_name]]
      #
