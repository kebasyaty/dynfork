...
describe "Crystal Validator" do
  ...
  it "=> testing color", tags: "validator" do
    # Negative:
    Valid.color_code?("").should be_false
    Valid.color_code?("#f2ewq").should be_false
    # Positive:
    Valid.color_code?("#fff").should be_true
    Valid.color_code?("#f2f2f2").should be_true
    Valid.color_code?("#F2F2F2").should be_true
    Valid.color_code?("#00000000").should be_true
    Valid.color_code?("rgb(255,0,24)").should be_true
    Valid.color_code?("rgb(255, 0, 24)").should be_true
    Valid.color_code?("rgba(255, 0, 24, .5)").should be_true
    Valid.color_code?("rgba(#fff, .5)").should be_true
    Valid.color_code?("rgba(#fff,.5)").should be_true
    Valid.color_code?("rgba(#FFF, .5)").should be_true
    Valid.color_code?("rgba(#FFF,.5)").should be_true
    Valid.color_code?("hsl(120, 100%, 50%)").should be_true
    Valid.color_code?("hsl(120,100%,50%)").should be_true
    Valid.color_code?("hsla(170, 23%, 25%, 0.2)").should be_true
    Valid.color_code?("hsla(170,23%,25%,0.2)").should be_true
    Valid.color_code?("0x00ffff").should be_true
    Valid.color_code?("0x00FFFF").should be_true
  end
