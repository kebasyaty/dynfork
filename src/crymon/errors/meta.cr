...
module Crymon::Errors::Meta
  ...
  class ParameterMissing < Crymon::Errors::CrymonException
    def initialize(
      model_name : String,
  ...
  class InvalidParamName < Crymon::Errors::CrymonException
    def initialize(
      model_name : String,
      parameter_name : String
    )
  ...
  class ParamExcessChars < Crymon::Errors::CrymonException
    def initialize(
      model_name : String,
      parameter_name : String,
      limit_size : UInt32
  ...
  class ParamRegexFails < Crymon::Errors::CrymonException
    def initialize(
      model_name : String,
      parameter_name : String,
      regex_str : String
