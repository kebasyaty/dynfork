...
module Crymon::Errors::Model
  ...
  class ModelNameExcessChars < Crymon::Errors::Root::CrymonException
    def initialize(model_name : String)
  ...
  class ModelNameRegexFails < Crymon::Errors::Root::CrymonException
  ...
  class InvalidGroupNumber < Crymon::Errors::Root::CrymonException
