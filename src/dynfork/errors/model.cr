...
module DynFork::Errors::Model
  ...
  class FieldsMissing < DynFork::Errors::CrymonException
  ...
  class ModelNameExcessChars < DynFork::Errors::CrymonException
    def initialize(model_name : String)
  ...
  class ModelNameRegexFails < DynFork::Errors::CrymonException
    def initialize(
      model_name : String,
      regex_str : String
    )
  ...
  class InvalidGroupNumber < DynFork::Errors::CrymonException
    def initialize(
      model_name : String,
      field_name : String
    )
